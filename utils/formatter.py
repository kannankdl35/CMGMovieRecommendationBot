# ---------------------------------------------------------------------------
# ✅ CHANGED: "Suggest Me" (format_movies() and its GENRE/LANGUAGE label
# maps) has been removed along with the rest of that feature. Only the
# details-page formatter remains, shared by both search flows
